...
import com.example.application.views.index.IndexView;
import com.example.application.views.services.ServicesView;
import com.example.application.views.shipping.ShippingView;
import com.example.application.views.tracking.TrackingView;
...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Tracking", "la la-barcode", TrackingView.class), //

                new MenuItemInfo("Shipping", "la la-box-open", ShippingView.class), //

                new MenuItemInfo("Contact Us", "la la-question", ContactUsView.class), //
